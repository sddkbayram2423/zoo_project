...
public class MoveManager {
	...
	/*
	 * This function is used when switch loop, which in moveObjects function, choose
	 * case: "Sheep" Than the switch loop, which in this function, choose random
	 * direction for random selected sheep and it will move to the direction Before
	 * end of this function, checked selected sheep's position relative to
	 * enemies(Wolf,Lion,Hunter) or other sheeps. If the sheep moves in danger
	 * distance of enemies it is going to remove from sheeps list If the sheep moves
	 * less than 3 units from any sheep Entitymanger class is going to create random
	 * sheep and it will added sheeps list
	 */
	private void moveSheep(int direction) {
		...
		case "Right":
			...
			if (sheep != null) {
				...
				moveMessage = sheepIndex + ". sheep move to right direction " + Sheep.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
		...
		case "Left":
			...
			if (sheep != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(sheep.getX(), sheep.getY()));
				moveMessage = sheepIndex + ". sheep move to left direction " + Sheep.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
		...
		case "Up":
			...
			if (sheep != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(sheep.getX(), sheep.getY()));
				moveMessage = sheepIndex + ". sheep move to up direction " + Sheep.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
			break;
		case "Down":
			...
			if (sheep != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(sheep.getX(), sheep.getY()));
				moveMessage = sheepIndex + ". sheep move to down direction " + Sheep.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
			break;
		}
	...
	/*
	 * This function is used when switch loop, which in moveObjects function, choose
	 * case: "Wolf" Than the switch loop, which in this function, choose random
	 * direction for random selected wolf and it will move to the direction Before
	 * end of this function, checked selected wolf's position relative to
	 * enemiy(Hunter) or other wolfs. If the wolf moves within 4 units of any of its
	 * prey, that animal will removed its list If the wolf moves in danger distance
	 * of enemiy it is going to remove from wolfs list If the wolf moves less than 3
	 * units from any wolf Entitymanger class is going to create random wolf and it
	 * will added sheeps list
	 */
	private void moveWolf(int direction) {
		...
		case "Right":
			...
			if (wolf != null) {
				...
				moveMessage = wolfIndex + ". wolf move to right direction " + Wolf.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
		...
		case "Left":
			...
			if (wolf != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(wolf.getX(), wolf.getY()));
				moveMessage = wolfIndex + ". wolf  move to left direction " + Wolf.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
			break;
		case "Up":
			...
			if (wolf != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(wolf.getX(), wolf.getY()));
				moveMessage = wolfIndex + ". wolf  move to up direction " + Wolf.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
				;
			}
		...
		case "Down":
			...
			if (wolf != null) {
				...
				moveMessage = wolfIndex + ". wolf  move to down direction " + Wolf.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
				;
			}
	...
	/*
	 * This function is used when switch loop, which in moveObjects function, choose
	 * case: "Cock" Than the switch loop, which in this function, choose random
	 * direction for random selected cock and it will move to the direction Before
	 * end of this function, checked selected cock's position relative to
	 * enemiy(Hunter,Wolf) or hens. If the cock moves in danger distance of enemiy
	 * it is going to remove from cocks list If the cock moves less than 3 units
	 * from any hen Entitymanger class is going to create random hen or cock and it
	 * will added coks/hens list
	 */
	private void moveCock(int direction) {
		...
		case "Right":
			if (cock != null) {
				...
				moveMessage = cockIndex + ". cock move to right direction " + Cock.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
		...
		case "Left":
			if (cock != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(cock.getX(), cock.getY()));
				moveMessage = cockIndex + ". cock move to left direction " + Cock.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
		...
		case "Up":
			if (cock != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(cock.getX(), cock.getY()));
				moveMessage = cockIndex + ". cock move to up direction " + Cock.MOVE_UNIT + " unit - Total move unit : "
						+ totalMoveUnit;
			}
		...
		case "Down":
			if (cock != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(cock.getX(), cock.getY()));
				moveMessage = cockIndex + ". cock  move to down direction " + Cock.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
	...
	/*
	 * This function is used when switch loop, which in moveObjects function, choose
	 * case: "Lion" Than the switch loop, which in this function, choose random
	 * direction for random selected lion and it will move to the direction Before
	 * end of this function, checked selected lion's position relative to
	 * enemiy(Hunter) or other lions. If the lion moves within 5 units of any of its
	 * prey, that animal is will removed its list If the lion moves in danger
	 * distance of any enemiy it is going to remove from lions list If the lion
	 * moves less than 3 units from any lion Entitymanger class is going to create
	 * random lion and it will added lions list
	 */
	private void moveLion(int direction) {
		...
		case "Right":
			...
			if (lion != null) {
				...
				moveMessage = lionIndex + ". lion move to right direction " + Lion.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
		...
		case "Left":
			if (lion != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(lion.getX(), lion.getY()));
				moveMessage = lionIndex + ". lion move to left direction " + Lion.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
		...
		case "Up":
			if (lion != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(lion.getX(), lion.getY()));
				moveMessage = lionIndex + ". lion up to up direction " + Lion.MOVE_UNIT + " unit - Total move unit : "
						+ totalMoveUnit;
			}
		...
		case "Down":
			if (lion != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(lion.getX(), lion.getY()));
				moveMessage = lionIndex + ". lion move to down direction " + Lion.MOVE_UNIT
						+ " unit - Total move unit : " + totalMoveUnit;
			}
	...
	/*
	 * This function is used when switch loop, which in moveObjects function, choose
	 * case: "Hen" Than the switch loop, which in this function, choose random
	 * direction for random selected hen and it will move to the direction Before
	 * end of this function, checked selected hen's position relative to
	 * enemiy(Hunter,Wolf) or coks. Ýf the hen moves in danger distance of any
	 * enemiy it is going to remove from hens list If the hen moves less than 3
	 * units from any cock Entitymanger class is going to create random cock or hen
	 * and it will added hens/cocks list
	 */
	private void moveHen(int direction) {
		...
		case "Right":
			...
			if (hen != null) {
				...
				moveMessage = henIndex + ".hen move to right direction " + Hen.MOVE_UNIT + " unit - Total move unit : "
						+ totalMoveUnit;
			}
			break;
		case "Left":
		...
		case "Up":
			if (hen != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(hen.getX(), hen.getY()));
				moveMessage = henIndex + ". hen move to up direction " + Hen.MOVE_UNIT + " unit - Total move unit : "
						+ totalMoveUnit;
			}
			break;
		case "Down":
			if (hen != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(hen.getX(), hen.getY()));
				moveMessage = henIndex + ". hen move to down direction " + Hen.MOVE_UNIT + " unit - Total move unit : "
						+ totalMoveUnit;
			}
			break;
		}
	...
	/*
	 * This function is used when switch loop, which in moveObjects function, choose
	 * case: "Cow" Than the switch loop, which in this function, choose random
	 * direction for random selected cow and it will move to the direction Before
	 * end of this function, checked selected cow's position relative to
	 * enemiy(Hunter,Wolf,Lion) or other cows. Ýf the cow moves in danger distance
	 * of on any enemiy it is going to remove from cows list If the cow moves less
	 * than 3 units from any cow Entitymanger class is going to create random cow
	 * and it will added cows list
	 */
	private void moveCow(int direction) {
		...
		case "Right":
			...
			if (cow != null) {
				...
				moveMessage = cowIndex + ". cow move to right direction " + Cow.MOVE_UNIT + " unit - Total move unit : "
						+ totalMoveUnit;
			}
			break;
		case "Left":
			if (cow != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(cow.getX(), cow.getY()));
				moveMessage = cowIndex + ".cow move to left direction " + Cow.MOVE_UNIT + " unit - Total move unit : "
						+ totalMoveUnit;
			}
			break;
		case "Up":
			if (cow != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(cow.getX(), cow.getY()));
				moveMessage = cowIndex + ".cow move to up direction " + Cow.MOVE_UNIT + " unit - Total move unit : "
						+ totalMoveUnit;
			}
			break;
		case "Down":
			if (cow != null) {
				...
				entityManager.updateLocation(oldLocation, new EntitiyLocation(cow.getX(), cow.getY()));
				moveMessage = cowIndex + ".cow move to down direction " + Cow.MOVE_UNIT + " unit - Total move unit : "
						+ totalMoveUnit;
			}
			break;
		}
	...
	/*
	 * This function is used when switch loop, which in moveObjects function, choose
	 * case: "Hunter" Than the switch loop, which in this function, choose random
	 * direction for random selected hunter and it will move to the direction Before
	 * end of this function, checked selected hunter's position relative to other
	 * animals If the lion moves within 8 units of any of its prey, that animal is
	 * will removed its list
	 */
	private void moveHunter(int direction) {
		...
		case "Right":
			...
			moveMessage = "Hunter move to right direction " + Hunter.MOVE_UNIT + " unit - Total move unit : "
					+ totalMoveUnit;
			break;
		case "Left":
			...
			entityManager.updateLocation(oldLocation, new EntitiyLocation(hunter.getX(), hunter.getY()));
			moveMessage = "Hunter move to left direction " + Hunter.MOVE_UNIT + " unit - Total move unit : "
					+ totalMoveUnit;
			break;
		case "Up":
			...
			entityManager.updateLocation(oldLocation, new EntitiyLocation(hunter.getX(), hunter.getY()));
			moveMessage = "Hunter move to up direction " + Hunter.MOVE_UNIT + " unit - Total move unit : "
					+ totalMoveUnit;
			break;
		case "Down":
			...
			entityManager.updateLocation(oldLocation, new EntitiyLocation(hunter.getX(), hunter.getY()));
			moveMessage = "Hunter move to down direction " + Hunter.MOVE_UNIT + " unit - Total move unit : "
					+ totalMoveUnit;
			break;
		}
	...
	// This function check the total move unit whether it is less than 1000 unit or
	// not
